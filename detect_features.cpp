...
int main( int argc, char** argv )
{
    ...
    // sift feature detector
     cv::Ptr<SIFT> _detector = xfeatures2d::SIFT::create();
    ...
    //_detector = cv::xfeatures2d::create( "SIFT" );
    ...
    cout << "chegou aqui";
    // 求解pnp
    cv::solvePnPRansac( pts_obj, pts_img, cameraMatrix, cv::Mat(), rvec, tvec, false, 100, 0.99, 100, inliers );
    cout << "chegou aqui2";
